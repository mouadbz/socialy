...
const Cta = (props: Props) => {
  return (
    <div className="grid sm:grid-cols-2 gap-10 mx-auto mt-24 px-4 ">
      <div className="relative">
        {/* <div className="md:absolute relative hidden md:block w-96 h-96 bg-purple-100 rounded-full right-0 top-1/3" /> */}
        <Image
          src="/images/grow.png"
          alt="Happy Team"
      ...
      <div className="place-self-center">
        <h2 className="text-3xl md:text-4xl xl:text-5xl font-bold text-gray-800 dark:text-white tracking-tight -mt-2">
          Our <span className="text-primary">Mission</span>
        </h2>
        <p className="text-lg max-w-xl mt-2 leading-relaxed text-slate-500 dark:text-white">
        ...
        <ul className="grid mt-6 text-left gap-y-4">
          <li className="flex items-center gap-3 text-slate-800 dark:text-white/80">
            <svg
              viewBox="0 0 256 256"
              className="w-5 h-5"
